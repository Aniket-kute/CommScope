...
**2. Alteryx**: Alteryx was an excellent solution to this problem, but 
             <sub> a. It has limited functionalities with a free version </sub>
             <sub> b. It is expensive. We might have to buy licenses for all the users. We were planning to implement a similar automation system to different product lines within our Business unit, so getting permits for everyone would have cost our Business much money.</sub>
